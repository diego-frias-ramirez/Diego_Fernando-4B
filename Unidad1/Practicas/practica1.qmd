---
title: "Práctica 1 - Clases, Objetos y Atributos"
format: html
jupyter: python3
---

# Práctica 1 - Clases, Objetos y Atributos en Python

En esta práctica aprenderás los fundamentos de la programación orientada a objetos (POO) en Python:

- Qué es una clase y un objeto
- Cómo se crean atributos y métodos
- Cómo se instancian objetos
- Qué es la abstracción

Todos los ejercicios están documentados con comentarios dentro del código.
